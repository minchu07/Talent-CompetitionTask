...
export default class EmployeeProfile extends React.Component {
  ...
  componentDidMount() {
    console.log('my testingggggggggggg');
    this.loadData();
  }
  ...
  loadData() {
    ...
    $.ajax({
      ...
      url:
        'https://talentserviceprofile.azurewebsites.net/profile/profile/getEmployerProfile',
      headers: {
  ...
  saveData() {
    ...
    $.ajax({
      ...
      url:
        'https://talentserviceprofile.azurewebsites.net/profile/profile/saveEmployerProfile',
      headers: {
        'Authorization': 'Bearer ' + cookies,
        'Content-Type': 'application/json',
      },
